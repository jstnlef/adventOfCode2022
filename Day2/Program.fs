...
let mistakenGuide: MistakenGuide =
...
printfn "Total score for mistaken guide interpretation: %d" (MistakenGuide.calculateScore mistakenGuide)
printfn "Total score for proper guide interpretation: %d" (ProperGuide.calculateScore properGuide)
